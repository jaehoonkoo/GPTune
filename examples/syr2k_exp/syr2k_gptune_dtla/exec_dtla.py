...
task_s = {}
task_s['s']  = [[60,80],' -DSMALL_DATASET'] 
task_s['sm'] = [[130,160],' -DSM_DATASET'] 
task_s['m']  = [[200,240],' -DMEDIUM_DATASET'] 
task_s['ml'] = [[600,720],' -DML_DATASET'] 
task_s['l']  = [[1000,1200],' -DLARGE_DATASET'] 
task_s['xl'] = [[2000,2600],' -DEXTRALARGE_DATASET'] 

input_sizes= {}
input_sizes[(60,80)]  = [' -DSMALL_DATASET'] 
input_sizes[(130,160)] = [' -DSM_DATASET'] 
input_sizes[(200,240)] = [' -DMEDIUM_DATASET'] 
input_sizes[(600,720)] = [' -DML_DATASET'] 
input_sizes[(1000,1200)] = [' -DLARGE_DATASET'] 
input_sizes[(2000,2600)] = [' -DEXTRALARGE_DATASET']
################################### 
...
def create_gptune(Kernel_name, nodes, cores, n_param, param_start, param_name, i_min, i_max, task_name):
    ...
    Tuning_params = [p0,p1,p2,p3,p4,p5]
