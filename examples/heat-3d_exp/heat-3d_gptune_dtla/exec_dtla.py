...
def create_gptune(Kernel_name, nodes, cores, n_param, param_start, param_name, i_min, i_max, task_name):
    ...
    p1 = Categoricalnorm(["#pragma clang loop(m2) pack array(B) allocate(malloc)", " "], transform="onehot", name="p1") 
...
if __name__ == "__main__":
    ...
    for i, ss in zip(range(1,len(giventask),1),source_task):
        ...
        {"name": "p1","transformer": "onehot","type": "categorical","categories": ["#pragma clang loop(m2) pack array(B) allocate(malloc)", " "]},
