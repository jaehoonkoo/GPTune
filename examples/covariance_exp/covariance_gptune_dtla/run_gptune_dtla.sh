...
mpirun -np 1 python exec_dtla.py -nrun 30 -ntask 4 -optimization GPTune -dsize sm -kernel_name covariance -nparam 5 -param_start 1 -target sm -itarget 160 180 -imin 28 32 -imax 3800 4000 -ninit 0 -seed 2022
...
rm -rf gptune.db
mkdir ./TLA_experiments
mpirun -np 1 python exec_dtla.py -nrun 30 -ntask 4 -optimization GPTune -dsize ml -kernel_name covariance -nparam 5 -param_start 1 -target ml -itarget 720 830 -imin 28 32 -imax 3800 4000 -ninit 0 -seed 2022 
...
rm -rf gptune.db
mkdir ./TLA_experiments
mpirun -np 1 python exec_dtla.py -nrun 30 -ntask 4 -optimization GPTune -dsize xl -kernel_name covariance -nparam 5 -param_start 1 -target xl -itarget 2600 3000 -imin 28 32 -imax 3800 4000 -ninit 0 -seed 2022 
...
rm -rf gptune.db
mkdir ./TLA_experiments
mpirun -np 1 python exec_dtla.py -nrun 30 -ntask 4 -optimization GPTune -dsize sm -kernel_name covariance -nparam 5 -param_start 1 -target sm -itarget 160 180 -imin 28 32 -imax 3800 4000 -ninit 0 -seed 9999
...
rm -rf gptune.db
mkdir ./TLA_experiments
mpirun -np 1 python exec_dtla.py -nrun 30 -ntask 4 -optimization GPTune -dsize ml -kernel_name covariance -nparam 5 -param_start 1 -target ml -itarget 720 830 -imin 28 32 -imax 3800 4000 -ninit 0 -seed 9999 
...
rm -rf gptune.db
mkdir ./TLA_experiments
mpirun -np 1 python exec_dtla.py -nrun 30 -ntask 4 -optimization GPTune -dsize xl -kernel_name covariance -nparam 5 -param_start 1 -target xl -itarget 2600 3000 -imin 28 32 -imax 3800 4000 -ninit 0 -seed 9999 
