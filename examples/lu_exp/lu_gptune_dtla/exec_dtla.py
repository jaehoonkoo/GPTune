...
def create_gptune(Kernel_name, nodes, cores, n_param, param_start, param_name, i_min, i_max, task_name):
    ...
    ## tuning parameter
    Tuning_params = []
    p1 = Categoricalnorm(["#pragma clang loop(i1) pack array(A) allocate(malloc)", " "], transform="onehot", name="p1") 
...
if __name__ == "__main__":
    ...
    for i, ss in zip(range(1,len(giventask),1),source_task):
        ...
        meta_dict = {
            ...
            "input_space":i_space,
            "parameter_space": [
        {"name": "p1","transformer": "onehot","type": "categorical","categories": ["#pragma clang loop(i1) pack array(A) allocate(malloc)", " "]},
